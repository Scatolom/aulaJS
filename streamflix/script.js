//DOCUMENT = PAGINA INTEIRA DO JS
//getElementById -> procura pelo atributo id=""
//titulo-filme -> id do filme
...
tituloFilme.classList.add('elemento-selecionado')//adicionei um atributo.git
}
function selecionarPorClasse(){
    ...
    for(let i = 0; i < elementos.length; i++){
        ...
        elementos[i].classList.add('elementos-selecionados')
    }
}
